# ====================================================================================
# Setup Project
PROJECT_NAME := provider-playground
...
XPKGS = provider-playground
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-playground: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Playground CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Playground controllers
...
# This target prepares repo for your provider by replacing all "playground"
